...
export default function NewSinglePageAssessment() {
  ...
  useEffect(() => {
    ...
    setValidationErrors((prev) => {
      ...
      const next = prev.filter((err) => {
        ...
        if (err.elementId === 'education-currentClassSpecify' || err.fieldKey === 'currentClassSpecify') {
  ...
  }, [clientUuid, buildCurrentDraftRecord]);
  ...
  return (
    <AppShell>
      <div className="flex-1 w-full max-w-5xl mx-auto px-4 py-4 sm:py-6 space-y-6 pb-36 sm:pb-28">
